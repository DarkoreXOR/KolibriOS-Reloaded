...
**LOCAL FACT:** Workspace root contains `kernel/` (FASM), `rust_kernel/` (Rust Cuts A–AB freestanding utils), `tools/`, `docs/`, vendored `tools/fasm/`, and the immutable reference floppy image.
