...
.\target\release\kolibri_img.exe cow ..\..\kolibrios-0.7.7.0-9160-g944d74f01-en_US.img ..\..\dev_build\cut-i-on.img
.\target\release\kolibri_img.exe delete ..\..\dev_build\cut-i-on.img DOCPACK
.\target\release\kolibri_img.exe replace ..\..\dev_build\cut-i-on.img KERNEL.MNT ..\..\kernel\bin\kernel.mnt

& "C:\Program Files\qemu\qemu-system-i386.exe" `
  -fda ..\..\dev_build\cut-i-on.img -boot a `
...
| Config | Result |
|--------|--------|
| Rust ON (`USE_RUST_NTFS_DECODE_MCB_ENTRY=1`) | **PASS** — `running`; screendump `dev_build/cut-i-on.ppm` (1024×768) |
| Rust OFF (`=0`) | **PASS** — `running`; screendump `dev_build/cut-i-off.ppm` |
