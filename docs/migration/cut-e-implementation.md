...
.\target\release\kolibri_img.exe cow ..\..\kolibrios-0.7.7.0-9160-g944d74f01-en_US.img ..\..\tmp_images\cut-e-on.img
.\target\release\kolibri_img.exe delete ..\..\tmp_images\cut-e-on.img DOCPACK
.\target\release\kolibri_img.exe replace ..\..\tmp_images\cut-e-on.img KERNEL.MNT ..\..\kernel\bin\kernel.mnt

& "C:\Program Files\qemu\qemu-system-i386.exe" `
  -fda ..\..\tmp_images\cut-e-on.img -boot a `
...
| Config | Result |
|--------|--------|
| Rust ON (`USE_RUST_CHECKSUM_1=1`) | **PASS** — `query-status=running`; screendump `tmp_images/cut-e-on-desktop.png` |
| Rust OFF (`USE_RUST_CHECKSUM_1=0`) | **PASS** — `query-status=running`; screendump `tmp_images/cut-e-off-desktop.png` |
