...
- **Status:** foothold via Cuts Y/AT/BK/BU/CG (`fix_coff_relocs` + `get_coff_sym` + `coff_get_align` + `fix_coff_symbols` + `get_proc_ex`); loader orchestration remains FASM.
