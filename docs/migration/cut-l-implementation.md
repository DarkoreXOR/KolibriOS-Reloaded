...
.\target\release\kolibri_img.exe cow ..\..\kolibrios-0.7.7.0-9160-g944d74f01-en_US.img ..\..\tmp_images\cut-l-on.img
.\target\release\kolibri_img.exe delete ..\..\tmp_images\cut-l-on.img DOCPACK
.\target\release\kolibri_img.exe replace ..\..\tmp_images\cut-l-on.img KERNEL.MNT ..\..\kernel\bin\kernel.mnt

& "C:\Program Files\qemu\qemu-system-i386.exe" `
  -fda ..\..\tmp_images\cut-l-on.img -boot a `
...
| Config | Result |
|--------|--------|
| Rust ON (`USE_RUST_MOUSE_ACCELERATION=1`) | **PASS** — `running`; screendump `tmp_images/cut-l-on.ppm` (2359312 bytes) |
| Rust OFF (`=0`) | **PASS** — `running`; screendump `tmp_images/cut-l-off.ppm` (2359312 bytes) |
