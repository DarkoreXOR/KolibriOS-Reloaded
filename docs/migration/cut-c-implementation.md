...
.\target\release\kolibri_img.exe cow ..\..\kolibrios-0.7.7.0-9160-g944d74f01-en_US.img ..\..\dev_build\cut-c-on.img
.\target\release\kolibri_img.exe delete ..\..\dev_build\cut-c-on.img DOCPACK
.\target\release\kolibri_img.exe replace ..\..\dev_build\cut-c-on.img KERNEL.MNT ..\..\kernel\bin\kernel.mnt

& "C:\Program Files\qemu\qemu-system-i386.exe" `
  -fda ..\..\dev_build\cut-c-on.img -boot a `
...
| Config | Result |
|--------|--------|
| Rust ON (`USE_RUST_UTF16_UPPER=1`) | **PASS** — `query-status=running`; desktop screendump `dev_build/cut-c-on-desktop.png` |
| Rust OFF (`USE_RUST_UTF16_UPPER=0`) | **PASS** — `query-status=running`; desktop screendump `dev_build/cut-c-off-desktop.png` |
