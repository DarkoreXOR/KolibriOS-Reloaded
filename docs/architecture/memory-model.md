...
| Stack | Location | Role |
|-------|----------|------|
| Early TMP | `TMP_STACK_TOP = 0x008DF00` | Pre-high_code (raised Cut CK from `0x008DD00`; Cut CJ from `0x008DC00`; Cut CI from `0x008D800`; Cut CF from `0x008D000`; Cut CE from `0x008CC00`) |
