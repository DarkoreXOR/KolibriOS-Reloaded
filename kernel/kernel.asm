...
; Stage 2+3: Phase C + Cuts A–R production ON; diagnostic smokes D–R ON
...
if USE_RUST_REBASE_COFF
        call    rebase_coff_rust_smoke_test
end if
...
if USE_RUST_SET_WINDOW_CLIENTBOX
        ...
        ; Cut BX: bdfe_to_fat_date smoke (Rust when USE_RUST_BDFE_TO_FAT_DATE=1).
...
;Add IO access table - bit array of permitted ports
        ...
        call    v86_get_lin_addr_rust_smoke_test
