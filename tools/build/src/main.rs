...
#[command(
    ...
    long_about = "Coordinates the existing Rust freestanding blob build, FASM assemble, \
kolibri_img CoW packaging, and QEMU smoke workflow. Configuration: tools/build/config.toml."
)]
struct Cli {
