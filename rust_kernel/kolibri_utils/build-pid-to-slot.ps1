# Cut AA — pid_to_slot: freestanding build + extract reloc-free blobs.
#
...
Write-Host "Next: wire USE_RUST_PID_TO_SLOT trampoline + smoke; default OFF until gates pass"
