# Cut P — is_region_userspace: freestanding build + extract reloc-free blobs.
#
...
#   (+ all prior Cut A–O blobs)
#
# Does NOT assemble kernel.mnt (see docs/migration — Cut P Step 3).
...
# that reintroduces relocs into Cut A–O blobs).
...
Show-Blob "rust_is_region_userspace.bin"
Show-Blob "rust_test_app_header.bin"
Write-Host "Next: keep USE_RUST_IS_REGION_USERSPACE=0 until Step 7/8 approval"
