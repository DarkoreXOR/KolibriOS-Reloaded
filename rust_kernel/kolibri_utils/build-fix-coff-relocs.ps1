# Cut Y — fix_coff_relocs: freestanding build + extract reloc-free blobs.
#
...
Show-Blob "rust_xfs_get_addr_by_hash.bin"
Write-Host "Next: wire USE_RUST_FIX_COFF_RELOCS trampoline + smoke; default OFF until gates pass"
