# Cut AC — ipv4_route: freestanding build + extract reloc-free blobs.
#
...
Show-Blob "rust_fix_coff_relocs.bin"
Write-Host "Next: USE_RUST_IPV4_ROUTE trampoline + smoke; production ON after gates (Cut AC)"
