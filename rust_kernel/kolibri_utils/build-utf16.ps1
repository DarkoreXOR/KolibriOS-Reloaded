# UTF-16 encode migration: freestanding build + extract reloc-free blobs.
#
...
#
# Does NOT assemble kernel.mnt (see docs/migration/utf16-migration.md).
...
Write-Host "Next: assemble kernel with USE_RUST_UTF16 (see docs/migration/utf16-migration.md)"
