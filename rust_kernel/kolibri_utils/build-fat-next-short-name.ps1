# Cut K — fat_next_short_name: freestanding build + extract reloc-free blobs.
#
...
#   (+ all prior Cut A–J blobs)
#
# Does NOT assemble kernel.mnt (see docs/migration/cut-k-implementation.md).
...
# that reintroduces relocs into Cut A–J blobs).
...
Write-Host "Next: assemble kernel with USE_RUST_FAT_NEXT_SHORT_NAME (see docs/migration/cut-k-implementation.md)"
