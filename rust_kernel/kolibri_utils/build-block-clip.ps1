# Cut H — block_clip: freestanding build + extract reloc-free blobs.
#
...
#   (+ all prior Cut A–G blobs)
#
# Does NOT assemble kernel.mnt (see docs/migration/cut-h-implementation.md).
...
Write-Host "Next: assemble kernel with USE_RUST_BLOCK_CLIP (see docs/migration/cut-h-implementation.md)"
