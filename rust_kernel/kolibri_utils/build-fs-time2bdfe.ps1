# Cut T — fsTime2bdfe: freestanding build + extract reloc-free blobs.
#
...
Write-Host "Next: wire USE_RUST_FS_TIME2BDFE trampoline + smoke; default OFF until gates pass"
