# Cut C — UTF-16 uppercase (utf16toUpper): freestanding build + extract reloc-free blobs.
#
...
#
# Does NOT assemble kernel.mnt (see docs/migration/cut-c-implementation.md).
...
# that reintroduces relocs into Cut A/B/C blobs).
...
Write-Host "Next: assemble kernel with USE_RUST_UTF16_UPPER (see docs/migration/cut-c-implementation.md)"
