# Cut AG — ntfs_test_bootsec: freestanding build + extract reloc-free blobs.
#
...
Write-Host "Next: wire USE_RUST_NTFS_TEST_BOOTSEC trampoline + smoke; default OFF until gates pass"
