# Cut Q — UTF16to8: freestanding build + extract reloc-free blobs.
#
...
#   (+ all prior Cut A–P blobs)
#
# Does NOT assemble kernel.mnt / trampoline / USE_RUST_* (Cut Q Step 2 only).
...
# that reintroduces relocs into Cut A–P blobs).
...
Show-Blob "rust_utf16_to_8.bin"
Show-Blob "rust_is_region_userspace.bin"
Write-Host "Next: keep production FASM UTF16to8; no USE_RUST_UTF16_TO_8 until Step 3+ approval"
