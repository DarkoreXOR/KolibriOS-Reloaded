# Cut S — window._.check_window_position: freestanding build + extract reloc-free blobs.
#
...
Write-Host "Next: wire USE_RUST_CHECK_WINDOW_POSITION trampoline + smoke; default OFF until gates pass"
