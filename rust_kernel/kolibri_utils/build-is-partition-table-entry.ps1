# Cut Z — is_partition_table_entry: freestanding build + extract reloc-free blobs.
#
...
Show-Blob "rust_set_io_access_rights.bin"
Write-Host "Next: wire USE_RUST_IS_PARTITION_TABLE_ENTRY trampoline + smoke; default OFF until gates pass"
