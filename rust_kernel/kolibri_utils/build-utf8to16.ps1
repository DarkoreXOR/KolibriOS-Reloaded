# Cut AB — utf8to16: freestanding build + extract reloc-free blobs.
#
...
Write-Host "Next: USE_RUST_UTF8TO16 trampoline + smoke; production ON after gates (Cut AB)"
