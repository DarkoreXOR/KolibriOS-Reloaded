# Cut I — ntfs_decode_mcb_entry: freestanding build + extract reloc-free blobs.
#
...
#   (+ all prior Cut A–H blobs)
#
# Does NOT assemble kernel.mnt (see docs/migration/cut-i-implementation.md).
...
# that reintroduces relocs into Cut A–H blobs).
...
Write-Host "Next: assemble kernel with USE_RUST_NTFS_DECODE_MCB_ENTRY (see docs/migration/cut-i-implementation.md)"
