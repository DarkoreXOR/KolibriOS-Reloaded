# Cut AE — ntfs_datetime_to_bdfe: freestanding build + extract reloc-free blobs.
#
...
Write-Host "Next: wire USE_RUST_NTFS_DATETIME_TO_BDFE trampoline + smoke; default OFF until gates pass"
