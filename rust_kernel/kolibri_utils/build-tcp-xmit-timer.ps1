# Cut M — tcp_xmit_timer: freestanding build + extract reloc-free blobs.
#
...
#   (+ all prior Cut A–L blobs)
#
# Does NOT assemble kernel.mnt (see docs/migration/cut-m-implementation.md).
...
# that reintroduces relocs into Cut A–L blobs).
...
Show-Blob "rust_tcp_xmit_timer.bin"
Show-Blob "rust_mouse_acceleration.bin"
Show-Blob "rust_fat_next_short_name.bin"
Show-Blob "rust_ntfs_restore_usa.bin"
Show-Blob "rust_ntfs_decode_mcb_entry.bin"
Show-Blob "rust_block_clip.bin"
Show-Blob "rust_fs_calculate_time.bin"
Write-Host "Next: assemble kernel with USE_RUST_TCP_XMIT_TIMER (see docs/migration/cut-m-implementation.md)"
