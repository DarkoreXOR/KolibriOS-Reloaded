# Cut J — ntfs_restore_usa: freestanding build + extract reloc-free blobs.
#
...
#   (+ all prior Cut A–I blobs)
#
# Does NOT assemble kernel.mnt (see docs/migration/cut-j-implementation.md).
...
# that reintroduces relocs into Cut A–I blobs).
...
Write-Host "Next: assemble kernel with USE_RUST_NTFS_RESTORE_USA (see docs/migration/cut-j-implementation.md)"
