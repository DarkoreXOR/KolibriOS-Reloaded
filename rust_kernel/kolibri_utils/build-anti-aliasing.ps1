# Cut N — antiAliasing: freestanding build + extract reloc-free blobs.
#
...
#   (+ all prior Cut A–M blobs)
#
# Does NOT assemble kernel.mnt (see docs/migration/cut-n-implementation.md).
...
# that reintroduces relocs into Cut A–M blobs).
...
Show-Blob "rust_anti_aliasing.bin"
...
Write-Host "Next: assemble kernel with USE_RUST_ANTI_ALIASING (see docs/migration/cut-n-implementation.md)"
