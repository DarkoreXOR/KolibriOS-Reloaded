# Cut AD — is_protective_mbr: freestanding build + extract reloc-free blobs.
#
...
Write-Host "Next: wire USE_RUST_IS_PROTECTIVE_MBR trampoline + smoke; default OFF until gates pass"
