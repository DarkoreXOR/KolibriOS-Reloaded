# Cut O — test_app_header: freestanding build + extract reloc-free blobs.
#
...
#   (+ all prior Cut A–N blobs)
#
# Does NOT assemble kernel.mnt (see docs/migration/cut-o-implementation.md).
...
# that reintroduces relocs into Cut A–N blobs).
...
Show-Blob "rust_test_app_header.bin"
...
Write-Host "Next: assemble kernel with USE_RUST_TEST_APP_HEADER (see docs/migration/cut-o-implementation.md)"
