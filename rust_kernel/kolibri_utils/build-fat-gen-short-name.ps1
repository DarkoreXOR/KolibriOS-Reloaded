# Cut U — fat_gen_short_name: freestanding build + extract reloc-free blobs.
#
...
Write-Host "Next: wire USE_RUST_FAT_GEN_SHORT_NAME trampoline + smoke; default OFF until gates pass"
