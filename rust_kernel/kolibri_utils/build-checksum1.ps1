# Cut E — checksum_1: freestanding build + extract reloc-free blobs.
#
...
#   (+ all prior Cut A–D blobs)
#
# Does NOT assemble kernel.mnt (see docs/migration/cut-e-implementation.md).
...
# that reintroduces relocs into Cut A–E blobs).
...
Write-Host "Next: assemble kernel with USE_RUST_CHECKSUM_1 (see docs/migration/cut-e-implementation.md)"
