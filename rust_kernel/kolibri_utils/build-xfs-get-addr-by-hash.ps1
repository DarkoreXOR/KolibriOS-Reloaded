# Cut W — xfs._.get_addr_by_hash: freestanding build + extract reloc-free blobs.
#
...
Write-Host "Next: wire USE_RUST_XFS_GET_ADDR_BY_HASH trampoline + smoke; default OFF until gates pass"
