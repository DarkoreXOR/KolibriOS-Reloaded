# Cut R — xfs._.extent_unpack: freestanding build + extract reloc-free blobs.
#
...
Show-Blob "rust_xfs_extent_unpack.bin"
Show-Blob "rust_utf16_to_8.bin"
Show-Blob "rust_is_region_userspace.bin"
Write-Host "Next: wire USE_RUST_XFS_EXTENT_UNPACK trampoline + smoke; default OFF until gates pass"
