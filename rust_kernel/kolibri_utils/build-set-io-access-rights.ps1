# Cut X — set_io_access_rights: freestanding build + extract reloc-free blobs.
#
...
Write-Host "Next: wire USE_RUST_SET_IO_ACCESS_RIGHTS trampoline + smoke; default OFF until gates pass"
