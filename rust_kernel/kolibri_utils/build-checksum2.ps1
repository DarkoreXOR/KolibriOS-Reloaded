# Cut F — checksum_2: freestanding build + extract reloc-free blobs.
#
...
#   (+ all prior Cut A–E blobs)
#
# Does NOT assemble kernel.mnt (see docs/migration/cut-f-implementation.md).
...
# that reintroduces relocs into Cut A–F blobs).
...
Write-Host "Next: assemble kernel with USE_RUST_CHECKSUM_2 (see docs/migration/cut-f-implementation.md)"
