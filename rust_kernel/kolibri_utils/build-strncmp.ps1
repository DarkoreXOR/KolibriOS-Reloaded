# Cut D — strncmp: freestanding build + extract reloc-free blobs.
#
...
#
# Does NOT assemble kernel.mnt (see docs/migration/cut-d-implementation.md).
...
# that reintroduces relocs into Cut A/B/C/D blobs).
...
Write-Host "Next: assemble kernel with USE_RUST_STRNCMP (see docs/migration/cut-d-implementation.md)"
