# Cut AF — ntfsCalculateTime: freestanding build + extract reloc-free blobs.
#
...
Write-Host "Next: wire USE_RUST_NTFS_CALCULATE_TIME trampoline + smoke; default OFF until gates pass"
